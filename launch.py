...
CONFIG_FILE_BASIC = os.environ["ARMA_CONFIG_BASIC"]
KEYS = "/arma3/keys"
STEAMCMDSECRET = os.environ["STEAMCMDSECRET"]
...
if clients != 0:
    ...
    launch += ' -cfg="/arma3/configs/{}"'.format(CONFIG_FILE_BASIC)
